...
4. [nxdc-milktea](https://github.com/hbcui1984/nxdc-milktea):仿奈雪の茶前端项目模板，基于`uni-app Vue3`开发
5. [nxdc-milktea-x](https://github.com/hbcui1984/nxdc-milktea-x)：仿奈雪の茶前端项目模板，基于`uni-app x`开发
6. [AlumNet](https://github.com/hbcui1984/AlumNet)：基于uni-app & uniCloud 的通用校友会小程序
7. [AlumNet-admin](https://github.com/hbcui1984/AlumNet-admin)：基于uni-app & uniCloud 的通用校友小程序管理端，基于`uni-admin`扩展
...
3. [uni-im](https://github.com/dcloudio/uni-im)：一款云端一体、全平台、免费且开源的即时通讯系统
